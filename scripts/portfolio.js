...
let projects = [
    {
        ...
        desc: `Guessy is as expected, an online guessing game, where the player can be engaged
                ...
                So much to find out!`,
        imageURL: `/assets/images/project-images/GuessyScreenshots/GuessySampleProject.webp`,
        ...
        imageURL: `/assets/images/project-images/ExtManager/extManager1.webp`,
        projectURL: "https://browser-extension-manager-cymains-projects.vercel.app",
    },{
        projectName: "Anime Recommendations Page",
        desc: `A little test of skill. This site uses HTML, CSS and JavaScript to make an interactive extension manager for all your browser extensions`,
        imageURL: `/assets/images/project-images/animeLandingPage/bocchiDesktopView.webp`,
        projectURL: "https://anime-landing-page-five.vercel.app",
    },
]
let skills = [
    {
        name: "HTML",
        cssName: "html-skill",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4.136 3.012h15.729l-1.431 16.15-6.451 1.826-6.414-1.826-1.433-16.15zm5.266 7.302-.173-2.035 7.533.002.173-1.963-9.87-.002.522 5.998h6.835l-.243 2.566-2.179.602-2.214-.605-.141-1.58H7.691l.247 3.123L12 17.506l4.028-1.08.558-6.111H9.402v-.001z"></path></svg>`,
        desc: "I use HTML to build the structure and hold the content of your site.",
        level: "Good",
        levelProgress: 85,
    },
    {
        name: "CSS",
        cssName: "css-skill",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4.192 3.143h15.615l-1.42 16.034-6.404 1.812-6.369-1.813L4.192 3.143zM16.9 6.424l-9.8-.002.158 1.949 7.529.002-.189 2.02H9.66l.179 1.913h4.597l-.272 2.62-2.164.598-2.197-.603-.141-1.569h-1.94l.216 2.867L12 17.484l3.995-1.137.905-9.923z"></path></svg>`,
        desc: "I use CSS to bring to reality, the beauty of your design",
        level: "Good",
        levelProgress: 90,
    },
    {
    ...
    },
    {
        ...
        desc: "Using Bootstrap to style your site quicker.",
        level: "Intermediate",
        levelProgress: 60,
    }, {
        name: "Tailwind CSS",
        cssName: "tailwind-skill",
        ...
        desc: "Using Tailwind to style your site quicker and load fast.",
        level: "Intermediate",
        levelProgress: 50,
    }
];
    ...
    let html = `
        ...
        <section id="my-skills">
            ...
            <div id="skills-container">
                ...
                <div class="skills">
                    <!--column flexbox containing all skills on mobile. Row flexbox for wide screens-->
                    ${renderSkills()}
                </div>
            </div>
        </section>
...
function renderSkills() {
    ...
    skills.forEach((skill, i) => {
        html += `
            <div class="skill ${skill.cssName}">
                <figure class="skill-icon">
                    ${skill.icon}
                </figure>
                <article class="skill-desc">
                    <h3 class="skill-name">${skill.name}</h3>
                    <p class="skill-me">${skill.desc}</p>
                    <div class="skill-level">
                        <span class="skill-level-text">${skill.level}</span>
                        <div class="skill-level-prog">
                            <div class="skill-level-bar">
                                <div class="skill-level-progress" data-index=${i}></div>
                            </div>
                            <span class="skill-level-progress-text">${skill.levelProgress}%</span>
                            <!--This is the skill level bar. It will be filled based on the skill level progress-->
                        </div>
...
function setSkillProgress() {
    const skillProgressElements = document.querySelectorAll('.skill-level-progress');
    skillProgressElements.forEach((element, index) => {
        const skill = skills[index];
        element.style.width = `${skill.levelProgress}%`;
        element.style.backgroundColor = getSkillColor(skill.levelProgress);
    });
}

function getSkillColor(progress) {
    if (progress >= 80) {
        return '#4CAF50'; // Green for high skill level
    }
    if (progress >= 50) {
        return '#FF9800'; // Orange for medium skill level
    }
    return '#F44336'; // Red for low skill level
}
